...
declare const SegmentedButtonItem: ({ checked, accessibilityLabel, disabled, style, showSelectedCheck, icon, testID, label, onPress, segment, density, theme: themeOverrides, }: Props) => JSX.Element;
