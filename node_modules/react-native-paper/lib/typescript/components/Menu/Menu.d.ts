...
declare class Menu extends React.Component<Props, State> {
    static Item: {
        ({ leadingIcon, trailingIcon, dense, title, disabled, onPress, style, contentStyle, testID, titleStyle, accessibilityLabel, theme: themeOverrides, }: import("./MenuItem").Props): JSX.Element;
        displayName: string;
    };
    static defaultProps: {
        statusBarHeight: any;
