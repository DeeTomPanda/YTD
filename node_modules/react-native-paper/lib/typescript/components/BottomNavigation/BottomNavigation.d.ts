...
import { Animated, EasingFunction, StyleProp, TouchableWithoutFeedbackProps, ViewStyle } from 'react-native';
...
declare const BottomNavigation: {
    ({ navigationState, renderScene, renderIcon, renderLabel, renderTouchable, getLabelText, getBadge, getColor, getAccessibilityLabel, getTestID, activeColor, inactiveColor, keyboardHidesNavigationBar, barStyle, labeled, style, sceneAnimationEnabled, sceneAnimationType, sceneAnimationEasing, onTabPress, onIndexChange, shifting: shiftingProp, safeAreaInsets, labelMaxFontSizeMultiplier, compact: compactProp, testID, theme: themeOverrides, getLazy, }: Props): JSX.Element;
    /**
