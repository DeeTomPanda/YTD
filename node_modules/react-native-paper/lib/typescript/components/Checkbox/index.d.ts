...
declare const Checkbox: (({ theme: themeOverrides, ...props }: import("./Checkbox").Props) => JSX.Element) & {
    Item: {
        ({ style, status, label, onPress, labelStyle, theme: themeOverrides, testID, mode, position, accessibilityLabel, disabled, labelVariant, ...props }: import("./CheckboxItem").Props): JSX.Element;
        displayName: string;
    };
    Android: {
